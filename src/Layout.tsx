...
const Layout = () => {
  ...
  return (
    <div className="relative flex text-foreground-dark bg-black h-screen w-full">
      ...
      {/* <div className="fixed w-full left-[11.5rem] z-30"><Navbar /></div> */}
      <main className="fixed top-16 bottom-10 left-[11.5rem] bg-blue-500 right-10 z-40 w-full h-full flex flex-col justify-center">
