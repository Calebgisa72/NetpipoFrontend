...
const ComingSoon = ({ page }: ComingSoonProps) => {
  return (
    <div className="flex font-poppinskjesfdb items-center justify-center h-full dark:bg-background-dark py-4">
      <div className="p-5 mx-2 bg-background text-foreground dark:bg-background-dark border-background-dark dark:border-background border-[1px] rounded-[8px] shadow-custom dark:bg-dark-bg md:p-20">
